...
RUN apt-get update && apt-get install -y wget && \
    ...
    "https://huggingface.co/mabeltrang/happy-tree-friends-model/resolve/main/modelo.pt?v=2" && \
    wget -O backend/model/class_names.json \
    "https://huggingface.co/mabeltrang/happy-tree-friends-model/resolve/main/class_names.json?v=2"
